...
class SHACGAN(nn.Module):
    ...
    def __init__(self, args, gen_mask=None, gen_version='0', disc_version='0', gradient_penalty='dragan', loadable_state_dict=None):
        super(SHACGAN, self).__init__()
        self.args = args

        self.generator = generators.versions[gen_version](args, mask=gen_mask, z_size=Z_SIZE, content_channels=CONTENT_CHANNELS, dropout_rate=DROPOUT_RATE)
