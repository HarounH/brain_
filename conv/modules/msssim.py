# Stolen from: https://github.com/jorge-pessoa/pytorch-msssim/blob/master/pytorch_msssim/__init__.py
...
def create_window(window_size, channel=1):
    ...
    _3D_window = _2D_window.view(-1, 1).mm(_1D_window.t()).view(window_size, window_size, window_size).unsqueeze(0).unsqueeze(0)
...
def msssim(img1, img2, window_size=11, size_average=True, val_range=None, normalize=False):
    device = img1.device
    # original weights: [0.0448, 0.2856, 0.3001, 0.2363, 0.1333]
    weights = torch.FloatTensor([0.2990, 0.3141, 0.2474, 0.1395]).to(device)
