...
class RClassifier0(nn.Module):
    def __init__(self, args, loadable_state_dict=None, z_size=128, dropout_rate=0.5):
        ...
        self.activation0 = nn.Sequential(nn.LeakyReLU(0.2), nn.Dropout(p=0.5))
        self.activation1 = nn.Sequential(nn.LeakyReLU(0.2), nn.Dropout(p=0.5))
        self.activation2 = nn.Sequential(nn.LeakyReLU(0.2), nn.Dropout(p=0.5))
        self.activation3 = nn.Sequential(nn.LeakyReLU(0.2), nn.Dropout(p=0.5))
        self.activation4 = nn.Sequential(nn.LeakyReLU(0.2), nn.Dropout(p=0.5))
...
class Classifier0(nn.Module):
    def __init__(self, args, loadable_state_dict=None, z_size=128, dropout_rate=0.5):
        ...
        self.activation0 = nn.Sequential(nn.LeakyReLU(0.2), nn.Dropout(0.5))
        self.activation1 = nn.Sequential(nn.LeakyReLU(0.2), nn.Dropout(0.5))
        self.activation2 = nn.Sequential(nn.LeakyReLU(0.2), nn.Dropout(0.5))
        self.activation3 = nn.Sequential(nn.LeakyReLU(0.2), nn.Dropout(0.5))
        self.activation4 = nn.Sequential(nn.LeakyReLU(0.2), nn.Dropout(0.5))
