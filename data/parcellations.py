"""
Gael wouldn't make his agglomerative clustering variable public.
But his code was public.
So guess what I did?

https://github.com/nilearn/nilearn/blob/master/nilearn/regions/parcellations.py
